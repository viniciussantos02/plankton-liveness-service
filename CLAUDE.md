...
- **Spec de referência:** [`openapi.yaml`](src/main/resources/static/plankton-liveness-service-api.yaml) — fonte de verdade dos contratos de API
...
**Fonte de verdade: [`openapi.yaml`](src/main/resources/static/plankton-liveness-service-api.yaml)**
